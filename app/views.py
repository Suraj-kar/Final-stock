...
def home(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            high_val = float(high_val) if not high_val and open_val else round(open_val * 1.1, 2)
            low_val = float(low_val) if not low_val and open_val else round(open_val * 0.9, 2)
